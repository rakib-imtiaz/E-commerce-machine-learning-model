# -*- coding: utf-8 -*-
"""AdaBoost_E_Commerce.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/15PoSx-97TnL8s8NoXNRV__hwC3hk83CU
"""
...
def train_model():
    ...
    return ada, label_encoders, (X_train, X_test, y_train, y_test)

if __name__ == "__main__":
    ada, label_encoders, (X_train, X_test, y_train, y_test) = train_model()
else:
    ...
    try:
        ...
        ada, label_encoders, _ = train_model()